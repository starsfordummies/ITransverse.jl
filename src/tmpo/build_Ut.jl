...
function _build_Ut(sites::Vector{<:Index}, 
    scheme::TrotterScheme, mp::ModelParams; dt::Number, build_4o::Bool)
    if build_4o
        p = 1.0/(4 - 4^(1/3))
...
function build_Ut(sites::Vector{<:Index}, scheme::TrotterScheme, mp::ModelParams; dt::Number, build_4o::Bool=false)
...
function build_Ut(sites::Vector{<:Index}, tp::tMPOParams; dt::Number=tp.dt, build_4o::Bool=false)
    build_Ut(sites, tp.scheme, tp.mp; dt, build_4o)
end

function build_Ut(scheme::TrotterScheme, mp::ModelParams; kwargs...)
...
function build_Ut(tp::tMPOParams; dt::Number=tp.dt, kwargs...)
    build_Ut(tp.scheme, tp.mp; dt, kwargs...)
end
