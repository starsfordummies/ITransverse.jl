...
function gen_replacebond_onesite!(
    M::MPS,
    b::Int,
    phi::ITensor;
    normalize=nothing,
    ...
    #println("running factorize_gen with $indsMb indices")
...
"""
One-site "generalized DMRG" algo
"""
function dmrg_gen_onesite(H::MPO, psi0::gMPS, sweeps::Sweeps; kwargs...)
    ...
    return dmrg_gen_onesite(PH, psi0, sweeps; kwargs...)
end


function dmrg_gen_onesite(
    PH,
    psi0::gMPS,
    sweeps::Sweeps;
    which_decomp=nothing,
...
function dmrg_gen_onesite(
    ...
    return dmrg_gen_onesite(x1, psi0, _dmrg_sweeps(; nsweeps, maxdim, mindim, cutoff, noise); kwargs...)
end
