...
include("gen_onesite_replacebond.jl")
...
function dmrg_onesite_gen(H::MPO, psi0::MPS, sweeps::Sweeps; kwargs...)
    ...
    return dmrg_onesite_gen(PH, psi0, sweeps; kwargs...)
end
...
function dmrg_onesite_gen(
    ...
    return dmrg_onesite_gen(x1, psi0, _dmrg_sweeps(; nsweeps, maxdim, mindim, cutoff, noise); kwargs...)
end